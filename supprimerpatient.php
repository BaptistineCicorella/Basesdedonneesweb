...
//Requete pour supp
$pdoStat = $db->prepare('DELETE FROM patient WHERE Id_pat=:num LIMIT 1'); // on utilise 1 pour limiter la suppression à une ligne par execution 
...
if ($executeIsOk) {
    $message = "le contact du patient a été supprimé ! " ;
            ...
            <div>
                <h1>
                    <a href="menu.html" id="logo">
                        <h1> Suppression d'un patient dans la base de données </h1>
                    </a>
                </h1>
            </div>
